...
function ObterOpcao {
    ...
    while ($_opcao -lt 0 -or $_opcao -gt 17) {
        ...
        Write-Host -Object "2 - Instalar Chocolatey"
        Write-Host -Object "3 - Instalar atalhos de convidado do Google Chrome"
        Write-Host -Object "4 - Instalar Chromium"
        Write-Host -Object "5 - Instalar Java"
        Write-Host -Object "6 - Instalar Firefox ESR"
        Write-Host -Object "7 - Instalar Gimp"
        Write-Host -Object "8 - Instalar Git"
        Write-Host -Object "9 - Instalar IntelliJ IDEA"
        Write-Host -Object "10 - Instalar KeePass"
