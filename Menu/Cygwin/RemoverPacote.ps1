...
function Aplicar {
    ...
    try {
        ...
        Import-Module -Name ([System.IO.Path]::Combine([System.IO.Path]::GetDirectoryName([System.IO.Path]::GetDirectoryName([System.IO.Path]::GetDirectoryName($script:MyInvocation.MyCommand.Definition))), "functions", "Cygwin", "Uninstall-CygwinPackage.ps1")) -Global -Force
