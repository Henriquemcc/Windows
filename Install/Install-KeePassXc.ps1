...
Invoke-Expression -Command "winget install XP8K2L36VP0QMB --source msstore --silent --accept-source-agreements --accept-package-agreements"
...
# Manually installing
if (((-not (Test-Expression -Command "choco")) -and (-not (Test-Expression -Command "winget"))) -or ($LASTEXITCODE -ne 0)) {
